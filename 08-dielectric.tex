...
\[
	\phi \ge \phi_\mathrm{min},\quad \sin\phi_\mathrm{min} = n_2 / n_1.
\]
...
\[
	\eps_1\mu_1\omega^2 - g^2 = \eps_2\mu_2\omega^2 + q^2.
\]
...
\]
\[
	\overline{q}^2 + \overline{g}^2 = a^2\omega^2\eps_2\mu_2(\overline{\eps}\overline{\mu} - 1) = \overline{k}_2^2(\overline{\eps}\overline{\mu} - 1) = \overline{R}^2.
\]
